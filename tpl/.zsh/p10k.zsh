# Generated by Powerlevel10k configuration wizard on 2019-09-10 at 20:37 BST.
...
function _p9k_build_segment() {
  ...
  if [[ $_p9k_segment_name == echo_* ]]; then
    _p9k_echo_prompt $_p9k_segment_name[6,-1]
  elif [[ $_p9k_segment_name == custom_* ]]; then
...
_p9k_echo_prompt() {
  ...
  local string=POWERLEVEL9K_ECHO_${segment_name}
  string=${(P)string}
  local content="$(echo $string)"
  [[ -n $content ]] || return
  _p9k_prompt_segment "prompt_echo_$segment_name" $_p9k_color2 $_p9k_color1 "CUSTOM_${segment_name}_ICON" 0 '' "$content"
}
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND=76
  ...
  typeset -g POWERLEVEL9K_VCS_STAGED_ICON='%B+%b'
  ...
  # Git status: feature:master#tag ⇣42⇡42 *42 merge ~42 +42 !42 ?42 52fdf5489651e
  #
  ...
  vcs+=':-'${(g::)POWERLEVEL9K_VCS_COMMIT_ICON}'${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+'${(g::)POWERLEVEL9K_VCS_REMOTE_BRANCH_ICON}'${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+'${(g::)POWERLEVEL9K_VCS_TAG_ICON}'${VCS_STATUS_TAG//\%/%%}}'
  # ⇣42 if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ '${(g::)POWERLEVEL9K_VCS_INCOMING_CHANGES_ICON}'${VCS_STATUS_COMMITS_BEHIND}}'
  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
  # If you want '⇣42 ⇡42' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }'${(g::)POWERLEVEL9K_VCS_OUTGOING_CHANGES_ICON}'${VCS_STATUS_COMMITS_AHEAD}}'
  # ~42 if have merge conflicts.
  vcs+='${${VCS_STATUS_NUM_CONFLICTED:#0}:+ '${(g::)POWERLEVEL9K_VCS_CONFLICTED_ICON}'${VCS_STATUS_NUM_CONFLICTED}}'
  # +42 if have staged changes.
  vcs+='${${VCS_STATUS_NUM_STAGED:#0}:+ '${(g::)POWERLEVEL9K_VCS_STAGED_ICON}'${VCS_STATUS_NUM_STAGED}}'
  # !42 if have unstaged changes.
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+${${(M)VCS_STATUS_NUM_STAGED:#0}:+ }'${(g::)POWERLEVEL9K_VCS_UNSTAGED_ICON}'${VCS_STATUS_NUM_UNSTAGED}}'
  # ?42 if have untracked files. It's really a question mark, your font isn't broken.
  # See POWERLEVEL9K_VCS_UNTRACKED_ICON below if you want to use a different icon.
  # Remove the next line if you don't want to see untracked files at all.
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+${${(M)$((VCS_STATUS_NUM_STAGED+VCS_STATUS_NUM_UNSTAGED)):#0}:+ }'${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}'${VCS_STATUS_NUM_UNTRACKED}}'
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ '${(g::)POWERLEVEL9K_VCS_STASH_ICON}'${VCS_STATUS_STASHES}}'
  # 'merge' if the repo is in an unusual state.
  vcs+='${VCS_STATUS_ACTION:+ [${VCS_STATUS_ACTION//\%/%%}} in progress]'
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=12
  # Custom icon.
  ...
  typeset -g P9K_STATUS_CROSS=true
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION="%B﬌ ✗"

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_CONTENT_EXPANSION='%B${P9K_CONTENT}'
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BOLD=true
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_VISUAL_IDENTIFIER_EXPANSION='%B﬌ ✗'
  ...
  ####################################[ context: user@host ]####################################
  # Default context icon.
  typeset -g POWERLEVEL9K_CONTEXT_VISUAL_IDENTIFIER_EXPANSION=''
  # Default context color.
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=7
  # Default context format: %n is username, %m is hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE="%B%F{13}%n%F{7}%b@%B%F{5}`scutil --get ComputerName`%f"

  # Context icon when running with privileges.
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%B%F{12}%n%F{7}%b@%B%F{4}`scutil --get ComputerName`%f"
  ...
  # Format for the current time: 09:51 am. See `man 3 strftime`.
